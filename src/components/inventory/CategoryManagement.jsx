...
function CategoryManagementModal({ isOpen, onClose }) {
  ...
  const createCategoryMutation = useMutation({
    mutationFn: (data) => apiRequest('POST', `${import.meta.env.VITE_API_URL}/api/categories`, data),
    onSuccess: () => {
  ...
  const deleteCategoryMutation = useMutation({
    mutationFn: (id) => apiRequest('DELETE', `${import.meta.env.VITE_API_URL}/api/categories/${id}`),
    onSuccess: () => {
      queryClient.invalidateQueries([`${import.meta.env.VITE_API_URL}/api/categories`]);
