...
export default function Companies() {
  ...
  const { data: companiesData, isLoading } = useQuery({
    queryKey: [`${import.meta.env.VITE_API_URL}/api/companies`, { city: cityFilter, unitName: unitFilter, name: searchTerm }],
    queryFn: () => {
      const params = {};
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries([`${import.meta.env.VITE_API_URL}/api/companies`]);
      setShowForm(false);
