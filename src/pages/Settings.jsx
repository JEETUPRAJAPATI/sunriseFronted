...
export default function Settings() {
  ...
  const { data: settingsData, isLoading } = useQuery({
    queryKey: [`${import.meta.env.VITE_API_URL}/api/settings`],
    enabled: true
  });
  ...
  const handleCompanyUpdate = () => {
    updateSettingsMutation.mutate({
      endpoint: `${import.meta.env.VITE_API_URL}/api/settings/company`,
      data: companyData
    });
  };
  ...
  const handleSystemUpdate = () => {
    updateSettingsMutation.mutate({
      endpoint: `${import.meta.env.VITE_API_URL}/api/settings/system`,
      data: systemData
    });
  };
  ...
  const handleEmailUpdate = () => {
    updateSettingsMutation.mutate({
      endpoint: `${import.meta.env.VITE_API_URL}/api/settings/email`,
      data: emailData
    });
  };
  ...
  const handleModuleUpdate = () => {
    updateSettingsMutation.mutate({
      endpoint: `${import.meta.env.VITE_API_URL}/api/settings/modules`,
      data: moduleSettings
    });
  };
  ...
  const handleNotificationUpdate = () => {
    updateSettingsMutation.mutate({
      endpoint: `${import.meta.env.VITE_API_URL}/api/settings/notifications`,
